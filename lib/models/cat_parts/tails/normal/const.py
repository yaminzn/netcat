...
<g id="tailFur">
  ...
  <g clip-path="url(#tailFurClipPath)">
      <path fill="{color}" d="M1904 1437.5h939v808.41h-939z"></path>
      <defs>
          <linearGradient id="tailShadowGradient" x1="2364.15" y1="2291.47" x2="2364.15" y2="2013.47"
          ...
          <linearGradient id="tailShadowGradient2" x1="2579.15" y1="1935.2" x2="2579.15" y2="1441.6"
              gradientUnits="userSpaceOnUse">
              <stop offset="0" stop-color="#fff" stop-opacity="0"></stop>
              <stop offset=".72" stop-color="#fff"></stop>
          </linearGradient>
          <linearGradient id="tailShadowGradient3" x1="2583.8" y1="2124.84" x2="2583.8" y2="1726.66"
      ...
      <g clip-path="url(#tailShadowClipPath)" style="mix-blend-mode:overlay">
          <path
              ...
              opacity=".35" fill="url(#tailShadowGradient2)" style="mix-blend-mode:overlay"></path>
      </g>
      <g clip-path="url(#tailShadowClipPath)" style="mix-blend-mode:multiply">
          <path
              ...
              opacity=".25" fill="url(#tailShadowGradient)" style="mix-blend-mode:multiply"></path>
          <path
